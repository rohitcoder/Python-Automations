...
page_access_token = ""
user_access_token = ""
source_page_ids = ['XXXX','YYYY','ZZZZ'] ## Source page ids from where i want to get random photos or memes
source_page_id = random.choice(source_page_ids)
url = "https://graph.facebook.com/"+source_page_id+"/photos?type=uploaded&access_token="+user_access_token
...
status_text = name
img_src = json['source']
url = "https://graph.facebook.com/"+page_id+"/photos?url="+urllib.quote(img_src)+"&caption="+status_text+"&access_token="+page_access_token
user_agent = {'User-Agent': 'Mozilla/5.0 (Windows; U; Windows NT 5.1; hu-HU; rv:1.7.8) Gecko/20050511 Firefox/1.0.4'}
